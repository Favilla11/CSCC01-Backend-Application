...
// Open Port, ser up the server itself on port 4000
app.listen(PORT, () => {
    console.log(`Server is running on http://localhost:${PORT}`);
  });

  // Register a new user
  /* defines an Express Post endpoint with the route /registerUser.
    There is an express.json() middleware function that helps with parsing requests that are
    explicitly using a JSON format.
    his is defined through the Headers portion of an HTTP request 
    (headers often help communicate important properties of HTTP requests)
  */
